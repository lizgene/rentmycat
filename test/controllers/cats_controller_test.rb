...
class CatsControllerTest < ActionController::TestCase
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post :create, cat: { description: @cat.description, image_url: @cat.image_url, name: @cat.name, price: @cat.price }
    end
  ...
  test "should update cat" do
    patch :update, id: @cat, cat: { description: @cat.description, image_url: @cat.image_url, name: @cat.name, price: @cat.price }
    assert_redirected_to cat_path(assigns(:cat))
  end
